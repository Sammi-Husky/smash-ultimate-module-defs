#ifndef BATTLEOBJECTWORLD_H
#define BATTLEOBJECTWORLD_H
namespace app::lua_bind {
    namespace BattleObjectWorld {
        ...
        u64 is_disable_reverse(app::BattleObjectWorld *) asm("_ZN3app8lua_bind42BattleObjectWorld__is_disable_reverse_implEPNS_17BattleObjectWorldE") LINKABLE;
        u64 is_gravity_normal(app::BattleObjectWorld *) asm("_ZN3app8lua_bind41BattleObjectWorld__is_gravity_normal_implEPNS_17BattleObjectWorldE") LINKABLE;
