...
namespace app::lua_bind {
    namespace StatusModule {
        ...
        u64 init_settings(app::BattleObjectModuleAccessor *,app::SituationKind,int,uint,app::GroundCliffCheckKind,bool,int,int,int,int) asm("_ZN3app8lua_bind32StatusModule__init_settings_implEPNS_26BattleObjectModuleAccessorENS_13SituationKindEijNS_20GroundCliffCheckKindEbiiii") LINKABLE;
        u64 is_changing(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind30StatusModule__is_changing_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_situation_changed(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind39StatusModule__is_situation_changed_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 prev_situation_kind(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind38StatusModule__prev_situation_kind_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 prev_status_kind(app::BattleObjectModuleAccessor *,uint) asm("_ZN3app8lua_bind35StatusModule__prev_status_kind_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
        ...
        u64 situation_kind(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind33StatusModule__situation_kind_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 status_kind(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind30StatusModule__status_kind_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
