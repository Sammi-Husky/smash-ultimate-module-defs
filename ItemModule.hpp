namespace ItemModule {
    ...
    u64 drop_attach_group(app::BattleObjectModuleAccessor *, uchar, float, float) asm("_ZN3app8lua_bind34ItemModule__drop_attach_group_implEPNS_26BattleObjectModuleAccessorEhff") LINKABLE;
    ...
    u64 set_attach_item_visibility(app::BattleObjectModuleAccessor *, bool, uchar) asm("_ZN3app8lua_bind43ItemModule__set_attach_item_visibility_implEPNS_26BattleObjectModuleAccessorEbh") LINKABLE;
    ...
    u64 set_have_item_constraint_joint(app::BattleObjectModuleAccessor *, phx::Hash40, int) asm("_ZN3app8lua_bind47ItemModule__set_have_item_constraint_joint_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ei") LINKABLE;
