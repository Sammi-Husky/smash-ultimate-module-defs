namespace ControlModule {
    ...
    u64 set_rumble(app::BattleObjectModuleAccessor *, phx::Hash40, int, bool, uint) asm("_ZN3app8lua_bind30ControlModule__set_rumble_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Eibj") LINKABLE;
    ...
    u64 stop_rumble_kind(app::BattleObjectModuleAccessor *, phx::Hash40, uint) asm("_ZN3app8lua_bind36ControlModule__stop_rumble_kind_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ej") LINKABLE;
    ...
    u64 get_trigger_count(app::BattleObjectModuleAccessor *, uchar) asm("_ZN3app8lua_bind37ControlModule__get_trigger_count_implEPNS_26BattleObjectModuleAccessorEh") LINKABLE;
    ...
    u64 get_trigger_count_prev(app::BattleObjectModuleAccessor *, uchar) asm("_ZN3app8lua_bind42ControlModule__get_trigger_count_prev_implEPNS_26BattleObjectModuleAccessorEh") LINKABLE;
    ...
    u64 set_command_life_extend(app::BattleObjectModuleAccessor *, uchar) asm("_ZN3app8lua_bind43ControlModule__set_command_life_extend_implEPNS_26BattleObjectModuleAccessorEh") LINKABLE;
    ...
    u64 set_special_command_life_count_extend(app::BattleObjectModuleAccessor *, uchar) asm("_ZN3app8lua_bind57ControlModule__set_special_command_life_count_extend_implEPNS_26BattleObjectModuleAccessorEh") LINKABLE;
}
