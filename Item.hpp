...
namespace app::lua_bind {
    namespace Item {
        ...
        u64 is_eatable(app::Item *,uint) asm("_ZN3app8lua_bind21Item__is_eatable_implEPNS_4ItemEj") LINKABLE;
        u64 is_had(app::Item *,bool) asm("_ZN3app8lua_bind17Item__is_had_implEPNS_4ItemEb") LINKABLE;
        ...
        u64 send_touch_message(app::Item *,uint,const Vector3f*,float) asm("_ZN3app8lua_bind29Item__send_touch_message_implEPNS_4ItemEjRKN3phx8Vector3fEf") LINKABLE;
