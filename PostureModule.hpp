#ifndef POSTUREMODULE_H
#define POSTUREMODULE_H
namespace app::lua_bind {
    namespace PostureModule {
        ...
        u64 is_rot_y_lr_different_inner_lr(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind50PostureModule__is_rot_y_lr_different_inner_lr_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 lr(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind22PostureModule__lr_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 pos_x(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind25PostureModule__pos_x_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 pos_y(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind25PostureModule__pos_y_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 pos_z(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind25PostureModule__pos_z_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        ...
        u64 set_pos(app::BattleObjectModuleAccessor *, const Vector3f*) asm("_ZN3app8lua_bind27PostureModule__set_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
        u64 set_pos_2d(app::BattleObjectModuleAccessor *, const Vector2f*) asm("_ZN3app8lua_bind30PostureModule__set_pos_2d_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fE") LINKABLE;
