namespace PostureModule {
    ...
    u64 add_pos(app::BattleObjectModuleAccessor *, phx::Vector3f const&) asm("_ZN3app8lua_bind27PostureModule__add_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
    u64 set_pos(app::BattleObjectModuleAccessor *, phx::Vector3f const&) asm("_ZN3app8lua_bind27PostureModule__set_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
    u64 set_rot(app::BattleObjectModuleAccessor *, phx::Vector3f const&, int) asm("_ZN3app8lua_bind27PostureModule__set_rot_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEi") LINKABLE;
    u64 init_pos(app::BattleObjectModuleAccessor *, phx::Vector3f const&, bool, bool) asm("_ZN3app8lua_bind28PostureModule__init_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEbb") LINKABLE;
    ...
    u64 add_pos_2d(app::BattleObjectModuleAccessor *, phx::Vector2f const&) asm("_ZN3app8lua_bind30PostureModule__add_pos_2d_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fE") LINKABLE;
    ...
    u64 set_pos_2d(app::BattleObjectModuleAccessor *, phx::Vector2f const&) asm("_ZN3app8lua_bind30PostureModule__set_pos_2d_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fE") LINKABLE;
    ...
    u64 set_sync_constraint_joint(app::BattleObjectModuleAccessor *, phx::Hash40) asm("_ZN3app8lua_bind45PostureModule__set_sync_constraint_joint_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
