namespace DamageModule {
    ...
    u64 set_force_damage(app::BattleObjectModuleAccessor *, uint, phx::Vector3f const&, int, int, bool, bool, bool, bool) asm("_ZN3app8lua_bind35DamageModule__set_force_damage_implEPNS_26BattleObjectModuleAccessorEjRKN3phx8Vector3fEiibbbb") LINKABLE;
