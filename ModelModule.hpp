...
namespace app::lua_bind {
    namespace ModelModule {
        u64 clear_joint_srt(app::BattleObjectModuleAccessor *, u64) asm("_ZN3app8lua_bind33ModelModule__clear_joint_srt_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
        ...
        u64 joint_global_offset_from_top(app::BattleObjectModuleAccessor *, u64, phx::Vector3f &) asm("_ZN3app8lua_bind46ModelModule__joint_global_offset_from_top_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERNS3_8Vector3fE") LINKABLE;
        u64 joint_global_position(app::BattleObjectModuleAccessor *, u64, phx::Vector3f &, bool) asm("_ZN3app8lua_bind39ModelModule__joint_global_position_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERNS3_8Vector3fEb") LINKABLE;
        u64 joint_global_position_with_offset(app::BattleObjectModuleAccessor *, u64, const Vector3f*, phx::Vector3f&, bool) asm("_ZN3app8lua_bind51ModelModule__joint_global_position_with_offset_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERKNS3_8Vector3fERS5_b") LINKABLE;
        u64 joint_global_rotation(app::BattleObjectModuleAccessor *, u64, phx::Vector3f &, bool) asm("_ZN3app8lua_bind39ModelModule__joint_global_rotation_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERNS3_8Vector3fEb") LINKABLE;
        u64 joint_rotate(app::BattleObjectModuleAccessor *, u64, phx::Vector3f &) asm("_ZN3app8lua_bind30ModelModule__joint_rotate_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERNS3_8Vector3fE") LINKABLE;
        ...
        u64 top_joint_global_position_from_joint(app::BattleObjectModuleAccessor *, u64, const Vector3f*, phx::Vector3f&) asm("_ZN3app8lua_bind54ModelModule__top_joint_global_position_from_joint_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERKNS3_8Vector3fERS5_") LINKABLE;
