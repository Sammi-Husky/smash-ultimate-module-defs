namespace PhysicsModule {
    ...
    u64 set_2nd_pos(app::BattleObjectModuleAccessor *, int, phx::Vector3f const&) asm("_ZN3app8lua_bind31PhysicsModule__set_2nd_pos_implEPNS_26BattleObjectModuleAccessorEiRKN3phx8Vector3fE") LINKABLE;
    ...
    u64 set_2nd_end_pos(app::BattleObjectModuleAccessor *, phx::Vector3f const&, phx::Vector3f const&) asm("_ZN3app8lua_bind35PhysicsModule__set_2nd_end_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fES6_") LINKABLE;
    ...
    u64 set_ik_target_pos(app::BattleObjectModuleAccessor *, int, phx::Vector3f const&, phx::Vector3f const&) asm("_ZN3app8lua_bind37PhysicsModule__set_ik_target_pos_implEPNS_26BattleObjectModuleAccessorEiRKN3phx8Vector3fES6_") LINKABLE;
    ...
    u64 set_swing_joint_name(app::BattleObjectModuleAccessor *, bool, phx::Hash40, bool) asm("_ZN3app8lua_bind40PhysicsModule__set_swing_joint_name_implEPNS_26BattleObjectModuleAccessorEbN3phx6Hash40Eb") LINKABLE;
