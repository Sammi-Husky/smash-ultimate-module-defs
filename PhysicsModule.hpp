...
namespace app::lua_bind {
    namespace PhysicsModule {
        ...
        u64 set_2nd_disable_collision(app::BattleObjectModuleAccessor *,uint,bool) asm("_ZN3app8lua_bind45PhysicsModule__set_2nd_disable_collision_implEPNS_26BattleObjectModuleAccessorEjb") LINKABLE;
