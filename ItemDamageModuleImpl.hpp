#ifndef ITEMDAMAGEMODULEIMPL_H
#define ITEMDAMAGEMODULEIMPL_H
namespace app::lua_bind {
    namespace ItemDamageModuleImpl {
        ...
        u64 is_smash_damage(app::BattleObjectModuleAccessor *,float,float) asm("_ZN3app8lua_bind42ItemDamageModuleImpl__is_smash_damage_implEPNS_26BattleObjectModuleAccessorEff") LINKABLE;
        }
    }
#endif // ITEMDAMAGEMODULEIMPL_H
