namespace TurnModule {
    ...
    u64 set_turn(app::BattleObjectModuleAccessor *, phx::Hash40, float, bool, bool, bool) asm("_ZN3app8lua_bind25TurnModule__set_turn_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Efbbb") LINKABLE;
    u64 is_extern(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind26TurnModule__is_extern_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
