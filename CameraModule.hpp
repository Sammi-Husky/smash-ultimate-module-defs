namespace CameraModule {
    ...
    u64 zoom_in(app::BattleObjectModuleAccessor *, int, int, float, phx::Vector2f const&, bool) asm("_ZN3app8lua_bind26CameraModule__zoom_in_implEPNS_26BattleObjectModuleAccessorEiifRKN3phx8Vector2fEb") LINKABLE;
    ...
    u64 set_priority(app::BattleObjectModuleAccessor *, uchar, int) asm("_ZN3app8lua_bind31CameraModule__set_priority_implEPNS_26BattleObjectModuleAccessorEhi") LINKABLE;
    u64 update_force(app::BattleObjectModuleAccessor *, int, phx::Vector3f const&, phx::Vector3f const&) asm("_ZN3app8lua_bind31CameraModule__update_force_implEPNS_26BattleObjectModuleAccessorEiRKN3phx8Vector3fES6_") LINKABLE;
    u64 req_quake_pos(app::BattleObjectModuleAccessor *, int, phx::Vector3f const&) asm("_ZN3app8lua_bind32CameraModule__req_quake_pos_implEPNS_26BattleObjectModuleAccessorEiRKN3phx8Vector3fE") LINKABLE;
    ...
    u64 start_final_zoom_out(app::BattleObjectModuleAccessor *, int, lib::Rect const&, phx::Vector3f const&) asm("_ZN3app8lua_bind39CameraModule__start_final_zoom_out_implEPNS_26BattleObjectModuleAccessorEiRKN3lib4RectERKN3phx8Vector3fE") LINKABLE;
    ...
    u64 set_enable_update_pos(app::BattleObjectModuleAccessor *, uchar, int) asm("_ZN3app8lua_bind40CameraModule__set_enable_update_pos_implEPNS_26BattleObjectModuleAccessorEhi") LINKABLE;
    u64 add_camera_range_offset(app::BattleObjectModuleAccessor *, phx::Vector3f const&, int) asm("_ZN3app8lua_bind42CameraModule__add_camera_range_offset_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEi") LINKABLE;
    u64 set_camera_range_offset(app::BattleObjectModuleAccessor *, phx::Vector3f const&, int) asm("_ZN3app8lua_bind42CameraModule__set_camera_range_offset_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEi") LINKABLE;
