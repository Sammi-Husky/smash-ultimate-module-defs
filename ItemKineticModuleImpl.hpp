#ifndef ITEMKINETICMODULEIMPL_H
#define ITEMKINETICMODULEIMPL_H
namespace app::lua_bind {
    namespace ItemKineticModuleImpl {
        ...
        u64 clear_speed(app::BattleObjectModuleAccessor *,bool) asm("_ZN3app8lua_bind39ItemKineticModuleImpl__clear_speed_implEPNS_26BattleObjectModuleAccessorEb") LINKABLE;
        ...
        u64 set_kinetic_flags(app::BattleObjectModuleAccessor *,uint) asm("_ZN3app8lua_bind45ItemKineticModuleImpl__set_kinetic_flags_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
        ...
        u64 set_throw_param(app::BattleObjectModuleAccessor *,const Vector3f*,const Vector3f*,bool,uint) asm("_ZN3app8lua_bind43ItemKineticModuleImpl__set_throw_param_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fES6_bj") LINKABLE;
        u64 slope_angle(app::BattleObjectModuleAccessor *,uint) asm("_ZN3app8lua_bind39ItemKineticModuleImpl__slope_angle_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
        }
    }
#endif // ITEMKINETICMODULEIMPL_H
