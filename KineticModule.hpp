#ifndef KINETICMODULE_H
#define KINETICMODULE_H
namespace app::lua_bind {
    namespace KineticModule {
        ...
        u64 clear_speed_all(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind35KineticModule__clear_speed_all_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 clear_speed_attr(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind36KineticModule__clear_speed_attr_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 clear_speed_energy_id(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind41KineticModule__clear_speed_energy_id_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 enable_energy(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind33KineticModule__enable_energy_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        ...
        u64 get_sum_rotation(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind36KineticModule__get_sum_rotation_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 get_sum_speed(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind33KineticModule__get_sum_speed_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 get_sum_speed3f(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind35KineticModule__get_sum_speed3f_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 get_sum_speed_length(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind40KineticModule__get_sum_speed_length_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 get_sum_speed_x(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind35KineticModule__get_sum_speed_x_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 get_sum_speed_y(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind35KineticModule__get_sum_speed_y_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 is_enable_energy(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind36KineticModule__is_enable_energy_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 is_suspend_energy(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind37KineticModule__is_suspend_energy_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        ...
        u64 unable_energy(app::BattleObjectModuleAccessor *,int) asm("_ZN3app8lua_bind33KineticModule__unable_energy_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
