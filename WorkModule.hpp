namespace WorkModule {
    ...
    u64 get_param_int(app::BattleObjectModuleAccessor *, ulong, ulong) asm("_ZN3app8lua_bind30WorkModule__get_param_int_implEPNS_26BattleObjectModuleAccessorEmm") LINKABLE;
    ...
    u64 get_param_float(app::BattleObjectModuleAccessor *, ulong, ulong) asm("_ZN3app8lua_bind32WorkModule__get_param_float_implEPNS_26BattleObjectModuleAccessorEmm") LINKABLE;
    u64 get_param_int64(app::BattleObjectModuleAccessor *, ulong, ulong) asm("_ZN3app8lua_bind32WorkModule__get_param_int64_implEPNS_26BattleObjectModuleAccessorEmm") LINKABLE;
