...
namespace app::lua_bind {
    namespace GrabModule {
        u64 clear_all(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind26GrabModule__clear_all_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_grab(app::BattleObjectModuleAccessor *, int) asm("_ZN3app8lua_bind24GrabModule__is_grab_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
