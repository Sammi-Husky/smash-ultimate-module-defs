#ifndef GROUNDMODULE_H
#define GROUNDMODULE_H
namespace app::lua_bind {
    namespace GroundModule {
        ...
        u64 get_down_correct_edge_pos(app::BattleObjectModuleAccessor *, phx::Vector2f &, const Vector2f*) asm("_ZN3app8lua_bind44GroundModule__get_down_correct_edge_pos_implEPNS_26BattleObjectModuleAccessorERN3phx8Vector2fERKS4_") LINKABLE;
        ...
        u64 ray_check_get_line_hit_pos(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, bool) asm("_ZN3app8lua_bind45GroundModule__ray_check_get_line_hit_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
        u64 ray_check_get_line_hit_pos_ignore_any(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, uint) asm("_ZN3app8lua_bind56GroundModule__ray_check_get_line_hit_pos_ignore_any_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_j") LINKABLE;
        u64 ray_check_get_line_hit_pos_no_culling(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, bool) asm("_ZN3app8lua_bind56GroundModule__ray_check_get_line_hit_pos_no_culling_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
        u64 ray_check_hit_normal(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, bool) asm("_ZN3app8lua_bind39GroundModule__ray_check_hit_normal_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
        u64 ray_check_hit_pos(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, bool) asm("_ZN3app8lua_bind36GroundModule__ray_check_hit_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
        u64 ray_check_hit_pos_normal(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind43GroundModule__ray_check_hit_pos_normal_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_S7_b") LINKABLE;
        u64 ray_check_hit_pos_normal_no_culling(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind54GroundModule__ray_check_hit_pos_normal_no_culling_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_S7_b") LINKABLE;
        u64 ray_check_hit_pos_target(app::BattleObjectModuleAccessor *, const Vector2f*, const Vector2f*, phx::Vector2f&, uint, bool) asm("_ZN3app8lua_bind43GroundModule__ray_check_hit_pos_target_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_jb") LINKABLE;
