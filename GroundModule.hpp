namespace GroundModule {
    ...
    u64 is_touch(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind27GroundModule__is_touch_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    ...
    u64 is_attach(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind28GroundModule__is_attach_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    u64 ray_check(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, bool) asm("_ZN3app8lua_bind28GroundModule__ray_check_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_b") LINKABLE;
    ...
    u64 is_ottotto(app::BattleObjectModuleAccessor *, float) asm("_ZN3app8lua_bind29GroundModule__is_ottotto_implEPNS_26BattleObjectModuleAccessorEf") LINKABLE;
    ...
    u64 is_miss_foot(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind31GroundModule__is_miss_foot_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    ...
    u64 get_touch_pos(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind32GroundModule__get_touch_pos_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    u64 is_attachable(app::BattleObjectModuleAccessor *, app::GroundTouchFlag) asm("_ZN3app8lua_bind32GroundModule__is_attachable_implEPNS_26BattleObjectModuleAccessorENS_15GroundTouchFlagE") LINKABLE;
    u64 is_near_cliff(app::BattleObjectModuleAccessor *, float, float) asm("_ZN3app8lua_bind32GroundModule__is_near_cliff_implEPNS_26BattleObjectModuleAccessorEff") LINKABLE;
    u64 is_ottotto_lr(app::BattleObjectModuleAccessor *, float, float) asm("_ZN3app8lua_bind32GroundModule__is_ottotto_lr_implEPNS_26BattleObjectModuleAccessorEff") LINKABLE;
    ...
    u64 set_shape_flag(app::BattleObjectModuleAccessor *, ushort, bool) asm("_ZN3app8lua_bind33GroundModule__set_shape_flag_implEPNS_26BattleObjectModuleAccessorEtb") LINKABLE;
    ...
    u64 is_attach_cliff(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind34GroundModule__is_attach_cliff_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    u64 is_status_cliff(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind34GroundModule__is_status_cliff_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    ...
    u64 set_init_circle(app::BattleObjectModuleAccessor *, phx::Vector2f const&, float) asm("_ZN3app8lua_bind34GroundModule__set_init_circle_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fEf") LINKABLE;
    u64 clear_pass_floor(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind35GroundModule__clear_pass_floor_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    u64 get_touch_normal(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind35GroundModule__get_touch_normal_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    ...
    u64 clear_cliff_point(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind36GroundModule__clear_cliff_point_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    ...
    u64 hang_cliff_pos_3f(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind36GroundModule__hang_cliff_pos_3f_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    u64 is_passable_check(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind36GroundModule__is_passable_check_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    u64 is_still_on_floor(app::BattleObjectModuleAccessor *, float, bool) asm("_ZN3app8lua_bind36GroundModule__is_still_on_floor_implEPNS_26BattleObjectModuleAccessorEfb") LINKABLE;
    u64 ray_check_hit_pos(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind36GroundModule__ray_check_hit_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
    ...
    u64 is_floor_vanishing(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind37GroundModule__is_floor_vanishing_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    u64 is_passable_ground(app::BattleObjectModuleAccessor *) asm("_ZN3app8lua_bind37GroundModule__is_passable_ground_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
    u64 is_wall_touch_line(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind37GroundModule__is_wall_touch_line_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    u64 ray_check_get_line(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, bool) asm("_ZN3app8lua_bind37GroundModule__ray_check_get_line_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_b") LINKABLE;
    ...
    u64 set_rhombus_offset(app::BattleObjectModuleAccessor *, phx::Vector2f const&) asm("_ZN3app8lua_bind37GroundModule__set_rhombus_offset_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fE") LINKABLE;
    u64 set_shape_safe_pos(app::BattleObjectModuleAccessor *, phx::Vector2f const&) asm("_ZN3app8lua_bind37GroundModule__set_shape_safe_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fE") LINKABLE;
    ...
    u64 is_floor_touch_line(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind38GroundModule__is_floor_touch_line_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    ...
    u64 ray_check_hit_normal(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind39GroundModule__ray_check_hit_normal_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
    ...
    u64 get_distance_to_floor(app::BattleObjectModuleAccessor *, phx::Vector3f const&, float, bool) asm("_ZN3app8lua_bind40GroundModule__get_distance_to_floor_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEfb") LINKABLE;
    ...
    u64 select_cliff_hangdata(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind40GroundModule__select_cliff_hangdata_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    ...
    u64 check_down_correct_pos(app::BattleObjectModuleAccessor *, phx::Vector2f) asm("_ZN3app8lua_bind41GroundModule__check_down_correct_pos_implEPNS_26BattleObjectModuleAccessorEN3phx8Vector2fE") LINKABLE;
    ...
    u64 get_line_movement_speed(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind42GroundModule__get_line_movement_speed_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    u64 get_touch_material_type(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind42GroundModule__get_touch_material_type_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    ...
    u64 get_touch_wall_cliff_pos(app::BattleObjectModuleAccessor *, uint, phx::Vector2f &) asm("_ZN3app8lua_bind43GroundModule__get_touch_wall_cliff_pos_implEPNS_26BattleObjectModuleAccessorEjRN3phx8Vector2fE") LINKABLE;
    ...
    u64 ray_check_hit_pos_normal(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind43GroundModule__ray_check_hit_pos_normal_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_S7_b") LINKABLE;
    u64 ray_check_hit_pos_target(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, uint, bool) asm("_ZN3app8lua_bind43GroundModule__ray_check_hit_pos_target_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_jb") LINKABLE;
    ...
    u64 can_entry_cliff_hang_data(app::BattleObjectModuleAccessor *, uint, app::GroundCliffCheckKind) asm("_ZN3app8lua_bind44GroundModule__can_entry_cliff_hang_data_implEPNS_26BattleObjectModuleAccessorEjNS_20GroundCliffCheckKindE") LINKABLE;
    u64 get_down_correct_edge_pos(app::BattleObjectModuleAccessor *, phx::Vector2f &, phx::Vector2f const&) asm("_ZN3app8lua_bind44GroundModule__get_down_correct_edge_pos_implEPNS_26BattleObjectModuleAccessorERN3phx8Vector2fERKS4_") LINKABLE;
    ...
    u64 ray_check_get_line_hit_pos(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind45GroundModule__ray_check_get_line_hit_pos_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
    ...
    u64 get_touch_normal_consider_gravity(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind52GroundModule__get_touch_normal_consider_gravity_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    u64 get_touch_normal_x_consider_gravity(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind54GroundModule__get_touch_normal_x_consider_gravity_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
    u64 ray_check_hit_pos_normal_no_culling(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind54GroundModule__ray_check_hit_pos_normal_no_culling_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_S7_b") LINKABLE;
    u64 ray_check_get_line_hit_pos_ignore_any(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, uint) asm("_ZN3app8lua_bind56GroundModule__ray_check_get_line_hit_pos_ignore_any_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_j") LINKABLE;
    u64 ray_check_get_line_hit_pos_no_culling(app::BattleObjectModuleAccessor *, phx::Vector2f const&, phx::Vector2f const&, phx::Vector2f&, bool) asm("_ZN3app8lua_bind56GroundModule__ray_check_get_line_hit_pos_no_culling_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector2fES6_RS4_b") LINKABLE;
    u64 set_shape_data_rhombus_modify_node_offset(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Vector3f const&) asm("_ZN3app8lua_bind60GroundModule__set_shape_data_rhombus_modify_node_offset_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERKNS3_8Vector3fE") LINKABLE;
}
