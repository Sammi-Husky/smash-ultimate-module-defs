namespace TeamModule {
    ...
    u64 set_team_owner_id(app::BattleObjectModuleAccessor *, uint) asm("_ZN3app8lua_bind34TeamModule__set_team_owner_id_implEPNS_26BattleObjectModuleAccessorEj") LINKABLE;
