namespace VisibilityModule {
    u64 set(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Hash40) asm("_ZN3app8lua_bind26VisibilityModule__set_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ES4_") LINKABLE;
    ...
    u64 set_default(app::BattleObjectModuleAccessor *, phx::Hash40) asm("_ZN3app8lua_bind34VisibilityModule__set_default_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
    ...
    u64 set_status_default(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Hash40) asm("_ZN3app8lua_bind41VisibilityModule__set_status_default_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ES4_") LINKABLE;
    u64 set_mesh_visibility(app::BattleObjectModuleAccessor *, phx::Hash40, int, bool) asm("_ZN3app8lua_bind42VisibilityModule__set_mesh_visibility_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Eib") LINKABLE;
    ...
    u64 set_material_anim_priority(app::BattleObjectModuleAccessor *, phx::Hash40, bool) asm("_ZN3app8lua_bind49VisibilityModule__set_material_anim_priority_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Eb") LINKABLE;
}
