namespace HitModule {
    ...
    u64 exist_log(app::BattleObjectModuleAccessor *, uint, int) asm("_ZN3app8lua_bind25HitModule__exist_log_implEPNS_26BattleObjectModuleAccessorEji") LINKABLE;
    ...
    u64 set_whole(app::BattleObjectModuleAccessor *, app::HitStatus, int) asm("_ZN3app8lua_bind25HitModule__set_whole_implEPNS_26BattleObjectModuleAccessorENS_9HitStatusEi") LINKABLE;
    ...
    u64 set_status(app::BattleObjectModuleAccessor *, int, app::HitStatus, int) asm("_ZN3app8lua_bind26HitModule__set_status_implEPNS_26BattleObjectModuleAccessorEiNS_9HitStatusEi") LINKABLE;
    ...
    u64 set_status_all(app::BattleObjectModuleAccessor *, app::HitStatus, int) asm("_ZN3app8lua_bind30HitModule__set_status_all_implEPNS_26BattleObjectModuleAccessorENS_9HitStatusEi") LINKABLE;
    ...
    u64 set_status_joint(app::BattleObjectModuleAccessor *, phx::Hash40, app::HitStatus, int) asm("_ZN3app8lua_bind32HitModule__set_status_joint_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ENS_9HitStatusEi") LINKABLE;
