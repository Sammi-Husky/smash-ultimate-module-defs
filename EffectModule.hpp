namespace EffectModule {
    u64 req(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Vector3f const&, phx::Vector3f const&, float, uint, int, bool, int) asm("_ZN3app8lua_bind22EffectModule__req_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERKNS3_8Vector3fES7_fjibi") LINKABLE;
    ...
    u64 req_2d(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Vector3f const&, phx::Vector3f const&, float, uint) asm("_ZN3app8lua_bind25EffectModule__req_2d_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ERKNS3_8Vector3fES7_fj") LINKABLE;
    u64 set_pos(app::BattleObjectModuleAccessor *, uint, phx::Vector3f const&) asm("_ZN3app8lua_bind26EffectModule__set_pos_implEPNS_26BattleObjectModuleAccessorEjRKN3phx8Vector3fE") LINKABLE;
    ...
    u64 set_rot(app::BattleObjectModuleAccessor *, uint, phx::Vector3f const&) asm("_ZN3app8lua_bind26EffectModule__set_rot_implEPNS_26BattleObjectModuleAccessorEjRKN3phx8Vector3fE") LINKABLE;
    u64 end_kind(app::BattleObjectModuleAccessor *, phx::Hash40, int) asm("_ZN3app8lua_bind27EffectModule__end_kind_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ei") LINKABLE;
    ...
    u64 req_emit(app::BattleObjectModuleAccessor *, phx::Hash40, uint) asm("_ZN3app8lua_bind27EffectModule__req_emit_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ej") LINKABLE;
    u64 req_time(app::BattleObjectModuleAccessor *, phx::Hash40, int, phx::Vector3f const&, phx::Vector3f const&, float, uint, bool, bool) asm("_ZN3app8lua_bind27EffectModule__req_time_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40EiRKNS3_8Vector3fES7_fjbb") LINKABLE;
    ...
    u64 kill_kind(app::BattleObjectModuleAccessor *, phx::Hash40, bool, bool) asm("_ZN3app8lua_bind28EffectModule__kill_kind_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ebb") LINKABLE;
    ...
    u64 set_scale(app::BattleObjectModuleAccessor *, uint, phx::Vector3f const&) asm("_ZN3app8lua_bind28EffectModule__set_scale_implEPNS_26BattleObjectModuleAccessorEjRKN3phx8Vector3fE") LINKABLE;
    ...
    u64 req_common(app::BattleObjectModuleAccessor *, phx::Hash40, float) asm("_ZN3app8lua_bind29EffectModule__req_common_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ef") LINKABLE;
    u64 req_follow(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Hash40, phx::Vector3f const&, phx::Vector3f const&, float, bool, uint, int, int, int, int, bool, bool) asm("_ZN3app8lua_bind29EffectModule__req_follow_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ES4_RKNS3_8Vector3fES7_fbjiiiibb") LINKABLE;
    u64 req_screen(app::BattleObjectModuleAccessor *, phx::Hash40, bool, bool, bool) asm("_ZN3app8lua_bind29EffectModule__req_screen_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ebbb") LINKABLE;
    u64 detach_kind(app::BattleObjectModuleAccessor *, phx::Hash40, int) asm("_ZN3app8lua_bind30EffectModule__detach_kind_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ei") LINKABLE;
    u64 remove_time(app::BattleObjectModuleAccessor *, phx::Hash40) asm("_ZN3app8lua_bind30EffectModule__remove_time_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
    ...
    u64 req_on_joint(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Hash40, phx::Vector3f const&, phx::Vector3f const&, float, phx::Vector3f const&, phx::Vector3f const&, bool, uint, int, int) asm("_ZN3app8lua_bind31EffectModule__req_on_joint_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ES4_RKNS3_8Vector3fES7_fS7_S7_bjii") LINKABLE;
    ...
    u64 kill_joint_id(app::BattleObjectModuleAccessor *, phx::Hash40, bool, bool) asm("_ZN3app8lua_bind32EffectModule__kill_joint_id_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ebb") LINKABLE;
    u64 remove_common(app::BattleObjectModuleAccessor *, phx::Hash40) asm("_ZN3app8lua_bind32EffectModule__remove_common_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
    u64 remove_screen(app::BattleObjectModuleAccessor *, phx::Hash40, int) asm("_ZN3app8lua_bind32EffectModule__remove_screen_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ei") LINKABLE;
    ...
    u64 is_exist_common(app::BattleObjectModuleAccessor *, phx::Hash40) asm("_ZN3app8lua_bind34EffectModule__is_exist_common_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
    ...
    u64 set_visible_kind(app::BattleObjectModuleAccessor *, phx::Hash40, bool) asm("_ZN3app8lua_bind35EffectModule__set_visible_kind_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Eb") LINKABLE;
    ...
    u64 set_custom_uv_offset(app::BattleObjectModuleAccessor *, uint, phx::Vector2f const&, int) asm("_ZN3app8lua_bind39EffectModule__set_custom_uv_offset_implEPNS_26BattleObjectModuleAccessorEjRKN3phx8Vector2fEi") LINKABLE;
    ...
    u64 get_dead_effect_rot_z(app::BattleObjectModuleAccessor *, phx::Vector3f const&, float, bool) asm("_ZN3app8lua_bind40EffectModule__get_dead_effect_rot_z_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEfb") LINKABLE;
    u64 get_dead_effect_scale(app::BattleObjectModuleAccessor *, phx::Vector3f const&, float, bool) asm("_ZN3app8lua_bind40EffectModule__get_dead_effect_scale_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fEfb") LINKABLE;
    ...
    u64 get_variation_effect_kind(app::BattleObjectModuleAccessor *, phx::Hash40, int) asm("_ZN3app8lua_bind44EffectModule__get_variation_effect_kind_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40Ei") LINKABLE;
    ...
    u64 request_post_effect_line_circle(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Hash40, phx::Vector2f, phx::Vector3f, bool, float, float) asm("_ZN3app8lua_bind50EffectModule__request_post_effect_line_circle_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ES4_NS3_8Vector2fENS3_8Vector3fEbff") LINKABLE;
    u64 set_post_effect_line_circle_target(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Vector2f, phx::Vector3f, bool) asm("_ZN3app8lua_bind53EffectModule__set_post_effect_line_circle_target_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ENS3_8Vector2fENS3_8Vector3fEb") LINKABLE;
