...
namespace app::lua_bind {
    namespace MotionModule {
        ...
        u64 is_anim_resource(u64,u64) asm("_ZN3app8lua_bind35MotionModule__is_anim_resource_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
        u64 is_blend(u64) asm("_ZN3app8lua_bind27MotionModule__is_blend_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_end(u64) asm("_ZN3app8lua_bind25MotionModule__is_end_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_end_2nd(u64) asm("_ZN3app8lua_bind29MotionModule__is_end_2nd_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_end_partial(u64,int) asm("_ZN3app8lua_bind33MotionModule__is_end_partial_implEPNS_26BattleObjectModuleAccessorEi") LINKABLE;
        u64 is_flag_link(u64,u64) asm("_ZN3app8lua_bind31MotionModule__is_flag_link_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
        u64 is_flag_start_1_frame(u64) asm("_ZN3app8lua_bind40MotionModule__is_flag_start_1_frame_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_flag_start_1_frame_from_motion_kind(u64,u64) asm("_ZN3app8lua_bind57MotionModule__is_flag_start_1_frame_from_motion_kind_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40E") LINKABLE;
        u64 is_flip(u64) asm("_ZN3app8lua_bind26MotionModule__is_flip_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_flip_resource(u64) asm("_ZN3app8lua_bind35MotionModule__is_flip_resource_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_loop_flag(u64) asm("_ZN3app8lua_bind31MotionModule__is_loop_flag_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_looped(u64) asm("_ZN3app8lua_bind28MotionModule__is_looped_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
        u64 is_no_comp(u64) asm("_ZN3app8lua_bind29MotionModule__is_no_comp_implEPNS_26BattleObjectModuleAccessorE") LINKABLE;
