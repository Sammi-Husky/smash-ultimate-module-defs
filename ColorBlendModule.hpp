namespace ColorBlendModule {
    ...
    u64 set_last_attack_direction(app::BattleObjectModuleAccessor *, phx::Vector3f const&) asm("_ZN3app8lua_bind48ColorBlendModule__set_last_attack_direction_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
