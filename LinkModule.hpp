namespace LinkModule {
    ...
    u64 send_event_nodes(app::BattleObjectModuleAccessor *, int, phx::Hash40, uint) asm("_ZN3app8lua_bind33LinkModule__send_event_nodes_implEPNS_26BattleObjectModuleAccessorEiN3phx6Hash40Ej") LINKABLE;
    ...
    u64 send_event_parents(app::BattleObjectModuleAccessor *, int, phx::Hash40) asm("_ZN3app8lua_bind35LinkModule__send_event_parents_implEPNS_26BattleObjectModuleAccessorEiN3phx6Hash40E") LINKABLE;
    ...
    u64 send_event_nodes_throw(app::BattleObjectModuleAccessor *, phx::Hash40, phx::Hash40, bool, int, int, int) asm("_ZN3app8lua_bind39LinkModule__send_event_nodes_throw_implEPNS_26BattleObjectModuleAccessorEN3phx6Hash40ES4_biii") LINKABLE;
    ...
    u64 set_constraint_rot_offset(app::BattleObjectModuleAccessor *, phx::Vector3f const&) asm("_ZN3app8lua_bind42LinkModule__set_constraint_rot_offset_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
    ...
    u64 set_constraint_scale_offset(app::BattleObjectModuleAccessor *, phx::Vector3f const&) asm("_ZN3app8lua_bind44LinkModule__set_constraint_scale_offset_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
    ...
    u64 set_model_constraint_pos_ort(app::BattleObjectModuleAccessor *, int, phx::Hash40, phx::Hash40, uint, bool) asm("_ZN3app8lua_bind45LinkModule__set_model_constraint_pos_ort_implEPNS_26BattleObjectModuleAccessorEiN3phx6Hash40ES4_jb") LINKABLE;
    ...
    u64 set_constraint_translate_offset(app::BattleObjectModuleAccessor *, phx::Vector3f const&) asm("_ZN3app8lua_bind48LinkModule__set_constraint_translate_offset_implEPNS_26BattleObjectModuleAccessorERKN3phx8Vector3fE") LINKABLE;
    ...
    u64 get_parent_model_joint_global_position(app::BattleObjectModuleAccessor *, int, phx::Hash40, bool) asm("_ZN3app8lua_bind55LinkModule__get_parent_model_joint_global_position_implEPNS_26BattleObjectModuleAccessorEiN3phx6Hash40Eb") LINKABLE;
